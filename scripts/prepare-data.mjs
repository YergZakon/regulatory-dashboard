...
const SECTION_RANGES = [
  ...
  [1486, 1499, 'J'], [1503, 1565, 'J'], [1570, 1627, 'K'],
  [1632, 1645, 'L'], [1650, 1736, 'M'], [1741, 1845, 'N'],
  [1846, 1870, 'O'], [1875, 1904, 'P'], [1909, 1945, 'Q'],
  [1950, 1994, 'R'], [1999, 2051, 'S'], [2056, 2065, 'T'],
  // Extended OKED codes (2069+) - fine-grained mapping
  [2069, 2075, 'A'],   // сельское хозяйство
  [2076, 2083, 'B'],   // горнодобыча
  [2084, 2160, 'C'],   // обрабатывающая промышленность
  [2161, 2161, 'N'],   // ремонт транспортного оборудования (admin)
  [2162, 2164, 'D'],   // электроэнергия, пар
  [2165, 2165, 'E'],   // утилизация
  [2166, 2172, 'F'],   // строительство
  [2173, 2226, 'G'],   // торговля
  [2227, 2234, 'H'],   // транспорт и складирование
  [2235, 2236, 'I'],   // гостиницы и питание
  [2237, 2246, 'J'],   // информация и связь
  [2247, 2254, 'K'],   // финансовая деятельность
  [2255, 2258, 'L'],   // операции с недвижимостью
  [2259, 2268, 'M'],   // профессиональная деятельность
  [2269, 2278, 'N'],   // административная деятельность
  [2279, 2279, 'O'],   // государственное управление
  [2280, 2282, 'P'],   // образование
  [2283, 2283, 'Q'],   // здравоохранение
  [2284, 2287, 'R'],   // искусство и развлечения
  [2288, 2300, 'S'],   // прочие услуги
];
